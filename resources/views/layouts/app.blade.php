...
<head>
    ...
    <title>Lysreyvyna Clinic Admin Website</title>
        ...
        <div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/post')}}"><i class="fa fa-file-o text-primary"></i>News and Education </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/video-training')}}"><i class="fa fa-youtube"></i> Latest Video </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/audio')}}"><i class="fa fa-file-sound-o"></i> Audio </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/page')}}"><i class="fa fa-columns"></i> Page </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/staff')}}"><i class="fa fa-users"></i> Staff </a>
                    </li>
